...
== a
#image("./discrete-fourier-series-a.png"),
...
== b
#image("./discrete-fourier-series-b.png")
...
#image("./discrete-fourier-series-c.png")
...
$
\
#let results = csv("./c-xn.csv")
$
#table(columns: 12, ..results.flatten())
$
\
$
a_k &= 1 / N sum_(n=<N>) x[n] e^(-j k omega_0 n) \
